...
public class MainPage {
	...
	public MainPage search(String text) {
		WebElement element = webController.waitForElementPresent(Locators.CSS, UILocators.CSS_LOCATOR_SEARCH, BrowserConstants.SLEEP_TIME);
		element.clear();
	...
	public MainPage selectRandomResultsSize() {
		WebElement element = webController.waitForElementPresent(Locators.XPATH, UILocators.XPATH_LOCATOR_SELECT, BrowserConstants.SLEEP_TIME);
